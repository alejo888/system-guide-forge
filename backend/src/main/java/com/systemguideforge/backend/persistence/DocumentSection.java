...
public class DocumentSection {
    ...
    public void updateEditableFields(String title, String content, int position, boolean hidden) { this.title = title; this.content = content; this.position = position; this.hidden = hidden; }
}
