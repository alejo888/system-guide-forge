...
public class AnalysisController {
    ...
    @GetMapping("/api/analyses/{id}/pages") public List<PageResponse> pages(@PathVariable String id){return service.pages(id).stream().map(p->new PageResponse(p.getId(),p.getAnalysisId(),p.getUrl(),p.getTitle(),p.getKind())).toList();}
    ...
    public record PageResponse(String id,String analysisId,String url,String title,PageKind kind){}
